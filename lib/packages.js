...
const packages = {
  ...
  fastify: { checked: true, hasRouter: true, version: '2.15.1' },
  'fastify-big-json': { extra: true, package: 'fastify', hasRouter: true, version: '2.15.1' },
  foxify: { hasRouter: true },
  hapi: { hasRouter: true, package: '@hapi/hapi' },
  koa: {},
  'koa-router': { hasRouter: true },
  micro: { extra: true },
  microrouter: { extra: true, hasRouter: true },
  'micro-route': { extra: true, hasRouter: true },
  'nestjs-express': { package: '@nestjs/core', hasRouter: true },
  'nestjs-fastify': { package: '@nestjs/core', hasRouter: true },
  'nestjs-fastify-service': { package: '@nestjs/core', hasRouter: true },
  ...
  'uWebSockets.js': { hasRouter: true, package: 'uWebSockets.js' },
  vapr: { hasRouter: true },
  'server-base': {},
